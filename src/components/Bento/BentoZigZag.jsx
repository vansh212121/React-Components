...
export default function BentoZigzag({ images = [], className = "" }) {
  ...
  return (
    <>
      <div className={`w-full max-w-7xl mx-auto p-4 ${className}`}>
        <div className="hidden md:grid grid-cols-6 auto-rows-[160px] gap-4">
          {/* Row 1 */}
          {/* Image 1 - Large left */}
          <div
            onClick={() => {
