...
export default function BentoLShape({ images = [], className = "" }) {
  ...
  return (
    <>
      <div className={`w-full max-w-7xl mx-auto p-4 ${className}`}>
        <div className="hidden md:grid grid-cols-5 auto-rows-[180px] gap-4">
          {/* Image 1 - Large L-shape vertical part */}
          <div
            onClick={() => {
              setActive(images[0]);
              setActiveIndex(0);
            }}
            className="col-span-2 row-span-3 relative overflow-hidden cursor-pointer group rounded-2xl"
          >
            <img
              src={images[0]?.src}
              alt={images[0]?.title}
          ...
          <div
            ...
            className="col-span-2 row-span-2 relative overflow-hidden cursor-pointer group rounded-2xl"
          >
            <img
              src={images[2]?.src}
              alt={images[2]?.title}
          ...
          {/* Image 5 - Wide L-shape horizontal part */}
          <div
            onClick={() => {
              setActive(images[4]);
              setActiveIndex(4);
