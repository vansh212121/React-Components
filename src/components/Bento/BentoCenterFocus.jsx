...
export default function BentoCenterFocus({ images = [], className = "" }) {
    ...
    <>
      <div className={`w-full max-w-7xl mx-auto p-4 ${className}`}>
        <div className="hidden md:grid grid-cols-4 auto-rows-[200px] gap-4">
          ...
          {/* Image 3 - Small top center-right */}
          <div
            onClick={() => {
              setActive(images[2]);
              setActiveIndex(2);
          ...
          {/* Image 6 - LARGE CENTER (Hero) */}
          <div
            onClick={() => {
              setActive(images[5]);
              setActiveIndex(5);
            }}
            className="col-span-2 row-span-2 relative overflow-hidden cursor-pointer group rounded-2xl ring-2 ring-white/20"
          >
            <img
              src={images[5]?.src}
              alt={images[5]?.title}
