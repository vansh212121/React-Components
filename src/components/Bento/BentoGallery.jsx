...
export default function BentoGallery({ images = [], className = "" }) {
  ...
  return (
    <>
      <div className={`w-full max-w-7xl mx-auto p-4 ${className}`}>
        {/* Desktop: Specific Bento Layout */}
        <div className="hidden md:grid grid-cols-5 auto-rows-[280px] gap-4">
          <div
            onClick={() => { setActive(images[0]); setActiveIndex(0); }}
            className="col-span-1 row-span-2 relative overflow-hidden cursor-pointer group rounded-2xl"
          >
            <img
              src={images[0]?.src}
              alt={images[0]?.title}
          ...
          <div
            onClick={() => { setActive(images[1]); setActiveIndex(1); }}
          ...
          <div
            onClick={() => { setActive(images[2]); setActiveIndex(2); }}
            className="col-span-1 row-span-1 relative overflow-hidden cursor-pointer group rounded-2xl"
          >
            <img
              src={images[2]?.src}
              alt={images[2]?.title}
          ...
          <div
            onClick={() => { setActive(images[3]); setActiveIndex(3); }}
            className="col-span-1 row-span-1 relative overflow-hidden cursor-pointer group rounded-2xl"
          >
            <img
              src={images[3]?.src}
          ...
          <div
            onClick={() => { setActive(images[4]); setActiveIndex(4); }}
          ...
          <div
            onClick={() => { setActive(images[5]); setActiveIndex(5); }}
            className="col-span-1 row-span-1 relative overflow-hidden cursor-pointer group rounded-2xl"
          >
            <img
              src={images[5]?.src}
        ...
        <div className="grid md:hidden grid-cols-2 gap-3">
          {images.map((img, i) => (
            <div
              key={img.id || i}
              onClick={() => { setActive(img); setActiveIndex(i); }}
