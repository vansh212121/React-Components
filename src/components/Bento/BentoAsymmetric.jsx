...
export default function BentoAsymmetric({ images = [], className = "" }) {
  ...
  return (
    <>
      <div className={`w-full max-w-7xl mx-auto p-4 ${className}`}>
        {/* Desktop: Asymmetric Flow */}
        <div className="hidden md:grid grid-cols-6 auto-rows-[200px] gap-4">
